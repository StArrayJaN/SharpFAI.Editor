...
/// <summary>
/// EditorPlayer - 编辑功能部分
/// 参�?ADOFAI-Editor/GLWindow.xaml.cs 的逻辑
/// </summary>
public partial class EditorPlayer
{
    ...
    /// <summary>
    /// 处理摄像机拖�?
    /// 参�?GLWindow.xaml.cs �?OnMouseMove 方法
    /// </summary>
    ...
    /// <summary>
    /// 处理鼠标滚轮缩放
    /// 参�?GLWindow.xaml.cs �?OnMouseWheel 方法
    /// </summary>
    ...
    /// <summary>
    /// 屏幕坐标转世界坐�?
    /// 参�?GLWindow.xaml.cs �?ScreenToWorldPosition 方法
    /// </summary>
    ...
    /// <summary>
    /// 处理地板点击
    /// 参�?GLWindow.xaml.cs �?OnMouseDown 方法
    /// </summary>
    ...
    private void HandleRangeSelection(int clickedIndex)
    {
        ...
        _statusMessage = $"已选择 {_selectedFloors.Count} 个地�?(索引 {startIndex}-{endIndex})";
    }
    ...
    /// <summary>
    /// 获取指定位置的地�?
    /// 参�?GLWindow.xaml.cs �?GetTileAtPosition 方法
    /// </summary>
    private Floor? GetFloorAtPosition(Vector2 worldPos)
    {
        ...
        for (int i = _floors.Count - 1; i >= 0; i--)
        {
            ...
            float threshold = Floor.width * 1.5f; // 增加一些容�?
